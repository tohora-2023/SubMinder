...
export default function LogIn() {
  ...
  // I wonder if you can use a ref/effect to focus the button when this component renders so that screen readers/keyboard users are aware of what pressing enter will do
